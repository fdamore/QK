...
q_c = Circuits.zzfeaturemap(n_wire=6)
...
n_shots_list = range(1200,1250,1)#run_1
...
#Best parameter: {'C': 8.0, 'gamma': 5.0, 'kernel': 'rbf'}
C_ = 8
gamma_ = 5
...
#save info.
np.savetxt("nhsots_zz_25.txt", np.array(n_shots_list))
np.savetxt("scores_zz_25.txt", np.array(list_score))
